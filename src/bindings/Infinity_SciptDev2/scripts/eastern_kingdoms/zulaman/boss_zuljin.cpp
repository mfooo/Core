...
{
//Speech
    SAY_AGGRO                 =  -1568057,//(-1568057,'Nobody badduh dan me!',12091,1,0,0,'zuljin SAY_AGGRO'),
    SAY_BEAR_TRANSFORM        =  -1568058,//(-1568058,'Got me some new tricks... like me brudda bear....',12092,1,0,0,'zuljin SAY_BEAR_TRANSFORM'),
    SAY_EAGLE_TRANSFORM       =  -1568059,//(-1568059,'Dere be no hidin\' from da eagle!',12093,1,0,0,'zuljin SAY_EAGLE_TRANSFORM'),
    SAY_LYNX_TRANSFORM        =  -1568060,//(-1568060,'Let me introduce you to me new bruddas: fang and claw!',12094,1,0,0,'zuljin SAY_LYNX_TRANSFORM'),
    SAY_DRAGONHAWK_TRANSFORM  =  -1568061,//(-1568061,'Ya don\' have to look to da sky to see da dragonhawk!',12095,1,0,0,'zuljin SAY_DRAGONHAWK_TRANSFORM'),
    SAY_FIRE_BREATH           =  -1568062,//(-1568062,'Fire kill you just as quick!',12096,1,0,0,'zuljin SAY_FIRE_BREATH'),
    SAY_BERSERK               =  -1568063,//(-1568063,'You too slow! Me too strong!',12097,1,0,0,'zuljin SAY_BERSERK'),
    SAY_KILL1                 =  -1568064,//(-1568064,'Da Amani de chuka!',12098,1,0,0,'zuljin SAY_KILL1'),
    SAY_KILL2                 =  -1568065,//(-1568065,'Lot more gonna fall like you!',12099,1,0,0,'zuljin SAY_KILL2'),
    SAY_DEATH                 =  -1568066,//(-1568066,'Mebbe me fall...but da Amani empire...never gonna die...',12100,1,0,0,'zuljin SAY_DEATH'),
//Spells:
// ====== Troll Form
